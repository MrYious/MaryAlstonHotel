                        ...
                        <div class=" w-full md:w-[55%] ">
                            ...
                            <div class=" w-full flex flex-wrap justify-around gap-2 lg:gap-7 bg-gray-300 py-3">
                                <div class="flex gap-2 items-center">
                                    ...
                                    <div class="text-xs lg:text-sm">Reserved </div>
                                </div>
                                <div class="flex gap-2 items-center">
            ...
            var calendar1 = new FullCalendar.Calendar(calendarEl1, {
                ...
                selectOverlap: function(event) {
                    if(event.groupId !== 'UNAVAILABLE'){
                        ...
                        $('#totalAmount').text(selectedReservation.booking.isDiscounted === 'true'? new Intl.NumberFormat().format(Math.round(selectedReservation.booking.costDiscounted)) + '.00' : selectedReservation.booking.costTotal);

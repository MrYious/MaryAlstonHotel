            ...
            var myTable = $('#myTable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        data: 'status',
                        render: function (data, type, row, meta) {
                            return `<div class="border-green-500 text-black border-b-2 text-center p-1 my-2">${data}</div>`
                        }
                    },
                    {
                        data: 'index',
...
`
            ...
            function getAllCompletedReservations() {
                ...
                $.post("/api/getAllReservationsPerStatus.php",{
                    ...
                    completedReservations.forEach( (reservation, i) => {
                        tableData[i] = {
                            index: i,
                            ...
                            costTotal: reservation.booking.isDiscounted === 'true'? new Intl.NumberFormat().format(Math.round(parseInt(reservation.booking.costDiscounted))) + '.00' : reservation.booking.costTotal,
